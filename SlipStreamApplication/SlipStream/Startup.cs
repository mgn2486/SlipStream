...
using SlipStream.DBContext.Repositories;
using System;
...
namespace SlipStream
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Description = "Slip Stream-API", Version = "v1.0" });
            });
            ...
            services.AddScoped<ICouchDbClientRepository, CouchDbClientRepository>();
        }
